...
from src.types.voxradar_news_scrapping_cnn_brasil_internacional_queue_dto import VoxradarNewsScrappingCNNBrasilInternacionalQueueDTO
...
class ScrappingNewsCNNBrasilInternacionalService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_cnnbrasil_queue_dto:VoxradarNewsScrappingCNNBrasilInternacionalQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do CNN Brasil Internacional: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do CNN Brasil Internacional: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do CNN Brasil Internacional: {url_news} | {e}")
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingCNNBrasilInternacionalQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingCNNBrasilInternacionalQueueDTO(body.get('url'))
