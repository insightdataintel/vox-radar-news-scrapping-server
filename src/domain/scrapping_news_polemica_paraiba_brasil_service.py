...
from src.types.voxradar_news_scrapping_polemica_paraiba_brasil_queue_dto import VoxradarNewsScrappingPolemicaParaibaBrasilQueueDTO
...
class ScrappingNewsPolemicaParaibaBrasilService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_polemicaparaiba_queue_dto:VoxradarNewsScrappingPolemicaParaibaBrasilQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Polemica Paraiba Brasil: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Polemica Paraiba Brasil: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Polemica Paraiba Brasil: {url_news} | {e}")
    ...
    # Pick image from news
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar imagens da notícia do Polemica Paraiba Brasil: {url_news} | {e}")     
            image_new = "" 
        # # #
        # #
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingPolemicaParaibaBrasilQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingPolemicaParaibaBrasilQueueDTO(body.get('url'))
