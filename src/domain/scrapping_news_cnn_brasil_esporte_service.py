...
from src.types.voxradar_news_scrapping_cnn_brasil_esporte_queue_dto import VoxradarNewsScrappingCNNBrasilEsporteQueueDTO
...
class ScrappingNewsCNNBrasilEsporteService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_cnnbrasil_queue_dto:VoxradarNewsScrappingCNNBrasilEsporteQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do CNN Brasil Esporte: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do CNN Brasil Esporte: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do CNN Brasil Esporte: {url_news} | {e}")
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingCNNBrasilEsporteQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingCNNBrasilEsporteQueueDTO(body.get('url'))
