...
class ScrappingNewsPoliticalivreMundoService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_politicalivre_queue_dto:VoxradarNewsScrappingPoliticalivreMundoQueueDTO = self.__parse_body(body)
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingPoliticalivreMundoQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingPoliticalivreMundoQueueDTO(body.get('url'))
