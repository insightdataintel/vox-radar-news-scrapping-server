...
from src.types.voxradar_news_scrapping_cnn_brasil_saude_queue_dto import VoxradarNewsScrappingCNNBrasilSaudeQueueDTO
...
class ScrappingNewsCNNBrasilSaudeService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_cnnbrasil_queue_dto:VoxradarNewsScrappingCNNBrasilSaudeQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do CNN Brasil Saude: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do CNN Brasil Saude: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do CNN Brasil Saude: {url_news} | {e}")
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingCNNBrasilSaudeQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingCNNBrasilSaudeQueueDTO(body.get('url'))
