...
from src.types.voxradar_news_scrapping_em_nacional_queue_dto import VoxradarNewsScrappingEmNacionalQueueDTO
...
class ScrappingNewsEmNacionalService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_emnacional_queue_dto:VoxradarNewsScrappingEmNacionalQueueDTO = self.__parse_body(body)
        url_news = voxradar_news_scrapping_emnacional_queue_dto.url
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Em Nacional: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        ...
        #
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Em Nacional: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Em Nacional: {url_news} | {e}")
            body_new = ""
    ...
    # Pick image from news
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar imagens da notícia do Em Nacional: {url_news} | {e}")     
            image_new = "" 
        # #
        # #
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingEmNacionalQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingEmNacionalQueueDTO(body.get('url'))
