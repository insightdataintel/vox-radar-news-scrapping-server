...
from src.types.voxradar_news_scrapping_politicalivre_justica_queue_dto import VoxradarNewsScrappingPoliticalivreJusticaQueueDTO
...
class ScrappingNewsPoliticalivreJusticaService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_politicalivre_queue_dto:VoxradarNewsScrappingPoliticalivreJusticaQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Politica Livre Justica: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Politica Livre Justica: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Politica Livre Justica: {url_news} | {e}")
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingPoliticalivreJusticaQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingPoliticalivreJusticaQueueDTO(body.get('url'))
