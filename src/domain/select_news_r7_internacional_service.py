...
class SelectNewsR7InternacionalService(BaseService):
    sqs: Sqs
    ...
    def exec(self) -> ReturnService:
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar os Links na página inicial do site r7 internacional | {e}")
    ...
    def __send_queue(self, url:str):
        message_queue:VoxradarNewsScrappingR7InternacionalQueueDTO = VoxradarNewsScrappingR7InternacionalQueueDTO(url)
