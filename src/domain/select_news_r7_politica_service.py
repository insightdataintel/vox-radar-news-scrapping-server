...
class SelectNewsR7PoliticaService(BaseService):
    sqs: Sqs
    ...
    def exec(self) -> ReturnService:
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar os Links na página inicial do site r7 politica | {e}")
    ...
    def __send_queue(self, url:str):
        message_queue:VoxradarNewsScrappingR7PoliticaQueueDTO = VoxradarNewsScrappingR7PoliticaQueueDTO(url)
