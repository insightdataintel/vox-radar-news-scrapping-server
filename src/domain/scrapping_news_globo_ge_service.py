...
class ScrappingNewsGloboGeService(BaseService):
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Globo Esporte: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        ...
        #
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Globo Esporte: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Globo Esporte: {url_news} | {e}")
    ...
    # Pick image from news
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar imagens da notícia do Globo Esporte: {url_news} | {e}")     
            image_new = "" 
        #
        #
