...
from src.types.voxradar_news_scrapping_reporter_diario_educacao_queue_dto import VoxradarNewsScrappingReporterDiarioEducacaoQueueDTO
...
class ScrappingNewsReporterDiarioEducacaoService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_reporterdiario_queue_dto:VoxradarNewsScrappingReporterDiarioEducacaoQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Reporter Diario Educacao: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Reporter Diario Educacao: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Reporter Diario Educacao: {url_news} | {e}")
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingReporterDiarioEducacaoQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingReporterDiarioEducacaoQueueDTO(body.get('url'))
