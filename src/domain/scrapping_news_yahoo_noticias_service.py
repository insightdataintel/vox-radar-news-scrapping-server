...
from src.types.voxradar_news_scrapping_yahoo_noticias_queue_dto import VoxradarNewsScrappingYahooNoticiasQueueDTO
...
class ScrappingNewsYahooNoticiasService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_yahoo_noticias_queue_dto:VoxradarNewsScrappingYahooNoticiasQueueDTO = self.__parse_body(body)
        url_news = voxradar_news_scrapping_yahoo_noticias_queue_dto.url
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Yahoo Noticias: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Yahoo Noticias: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Yahoo Noticias: {url_news} | {e}")
    ...
    # Pick image from news
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar imagens da notícia do Yahoo Noticias: {url_news} | {e}")     
            image_new = "" #
        # #
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingYahooNoticiasQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingYahooNoticiasQueueDTO(body.get('url'))
