...
class SelectNewsCNNBrasilBusinessService(BaseService):
    sqs: Sqs
    ...
    def exec(self) -> ReturnService:
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar os Links na página inicial do site cnn brasil business | {e}")
    ...
    def __send_queue(self, url:str):
        message_queue:VoxradarNewsScrappingCNNBrasilBusinessQueueDTO = VoxradarNewsScrappingCNNBrasilBusinessQueueDTO(url)
