...
class ScrappingNewsCorreio24horasService(BaseService):
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Correrio 24hrs: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Correrio 24hrs: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
#   
    ...
    # Pick image from news
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar imagens da notícia do Correrio 24hrs: {url_news} | {e}")     
            image_new = "" 
        #
        #
