...
from src.types.voxradar_news_scrapping_jornal_de_brasilia_brasilia_queue_dto import VoxradarNewsScrappingJornaldeBrasiliaBrasiliaQueueDTO
...
class ScrappingNewsJornaldeBrasiliaBrasiliaService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_jornaldebrasilianoticias_queue_dto:VoxradarNewsScrappingJornaldeBrasiliaBrasiliaQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Jornal de Brasilia Brasilia: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Jornal de Brasilia Brasilia: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Jornal de Brasilia Brasilia: {url_news} | {e}")
            body_new= ""    
    #    
    # Pick category news
    #   
        category_news = 'national'
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingJornaldeBrasiliaBrasiliaQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingJornaldeBrasiliaBrasiliaQueueDTO(body.get('url'))
