...
class SelectNewsEmSaudeService(BaseService):
    sqs: Sqs
    ...
    def exec(self) -> ReturnService:
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar os Links na página inicial do site em saude | {e}")
    ...
    def __send_queue(self, url:str):
        message_queue:VoxradarNewsScrappingEmSaudeQueueDTO = VoxradarNewsScrappingEmSaudeQueueDTO(url)
