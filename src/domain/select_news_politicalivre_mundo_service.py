...
from src.types.voxradar_news_scrapping_politicalivre_mundo_queue_dto import VoxradarNewsScrappingPoliticalivreMundoQueueDTO
from src.utils.utils import Utils
from ..config.envs import Envs
from .base.base_service import BaseService
from ..types.return_service import ReturnService

class SelectNewsPoliticalivreMundoService(BaseService):
    sqs: Sqs
    ...
    def exec(self) -> ReturnService:
        ...
        url = "https://politicalivre.com.br/category/mundo"
        
        try:
            links_filtered = Utils.extract_links_from_page_politicalivre(url)
        except Exception as e:
            self.logger.error(f"Não foi possível encontrar os Links na página inicial do site politicalivre mundo | {e}")
    ...
    def __send_queue(self, url:str):
        message_queue:VoxradarNewsScrappingPoliticalivreMundoQueueDTO = VoxradarNewsScrappingPoliticalivreMundoQueueDTO(url)
