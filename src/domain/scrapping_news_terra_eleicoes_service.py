...
from src.types.voxradar_news_scrapping_terra_eleicoes_queue_dto import VoxradarNewsScrappingTerraEleicoesQueueDTO
...
class ScrappingNewsTerraEleicoesService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_terra_eleicoes_queue_dto:VoxradarNewsScrappingTerraEleicoesQueueDTO = self.__parse_body(body)
        url_news = voxradar_news_scrapping_terra_eleicoes_queue_dto.url
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Terra Eleicoes: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        ...
        #
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Terra Eleicoes: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do Terra Eleicoes: {url_news} | {e}")
    ...
    # Pick image from news
        ...
        try:
            ...
            self.logger.error(f"Não foi possível encontrar imagens da notícia do Terra Eleicoes: {url_news} | {e}")     
            image_new = ""
        #
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingTerraEleicoesQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingTerraEleicoesQueueDTO(body.get('url'))
