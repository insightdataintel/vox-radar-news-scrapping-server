...
from src.types.voxradar_news_scrapping_cnn_brasil_tecnologia_queue_dto import VoxradarNewsScrappingCNNBrasilTecnologiaQueueDTO
...
class ScrappingNewsCNNBrasilTecnologiaService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_cnnbrasil_queue_dto:VoxradarNewsScrappingCNNBrasilTecnologiaQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do CNN Brasil Tecnologia: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do CNN Brasil Tecnologia: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingCNNBrasilTecnologiaQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingCNNBrasilTecnologiaQueueDTO(body.get('url'))
