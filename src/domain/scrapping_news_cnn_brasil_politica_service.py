...
from src.types.voxradar_news_scrapping_cnn_brasil_politica_queue_dto import VoxradarNewsScrappingCNNBrasilPoliticaQueueDTO
...
class ScrappingNewsCNNBrasilPoliticaService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_cnnbrasil_queue_dto:VoxradarNewsScrappingCNNBrasilPoliticaQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do CNN Brasil Politica: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do CNN Brasil Politica: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o corpo da notícia do CNN Brasil Politica: {url_news} | {e}")
            body_new= ""    
    #    
    # Pick category news
    #   
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingCNNBrasilPoliticaQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingCNNBrasilPoliticaQueueDTO(body.get('url'))
