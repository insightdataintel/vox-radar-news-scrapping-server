...
from src.types.voxradar_news_scrapping_reporter_diario_cidades_queue_dto import VoxradarNewsScrappingReporterDiarioCidadesQueueDTO
...
class ScrappingNewsReporterDiarioCidadesService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_reporterdiario_queue_dto:VoxradarNewsScrappingReporterDiarioCidadesQueueDTO = self.__parse_body(body)
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingReporterDiarioCidadesQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingReporterDiarioCidadesQueueDTO(body.get('url'))
