...
from src.types.voxradar_news_scrapping_jornal_de_brasilia_torcida_queue_dto import VoxradarNewsScrappingJornaldeBrasiliaTorcidaQueueDTO
...
class ScrappingNewsJornaldeBrasiliaTorcidaService(BaseService):
    ...
    def exec(self, body:str) -> ReturnService:
        ...
        voxradar_news_scrapping_jornaldebrasilianoticias_queue_dto:VoxradarNewsScrappingJornaldeBrasiliaTorcidaQueueDTO = self.__parse_body(body)
    ...
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar o título da notícia do Jornal de Brasilia Torcida: {url_news} | {e}")     
            title = ""
    #
    #Stardandizing Date
    #
        try:
            ...
            self.logger.error(f"Não foi possível encontrar a data da notícia do Jornal de Brasilia Torcida: {url_news} | {e}")
            date = ""    
    #
    #Pick body's news
    #
    ...
    def __parse_body(self, body:str) -> VoxradarNewsScrappingJornaldeBrasiliaTorcidaQueueDTO:
        body = json.loads(body)
        return VoxradarNewsScrappingJornaldeBrasiliaTorcidaQueueDTO(body.get('url'))
